...
/**
 * Borrow store
 * 提供 fetchBorrows(userId) 方法，返回后端响应中的 data 字段（借阅历史数组）
 */
  ...
  actions: {
    ...
    async fetchBorrows(userId) {
      ...
      try {
        ...
        // uni.request 成功返回对象通常包含 statusCode 和 data
        if (res && res.statusCode === 200) {
          const payload = res.data || {}
          // 假设后端返回 { statusCode:200, message:'', data: [...] }
        ...
        console.error('fetchBorrows error:', err)
